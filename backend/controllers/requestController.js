...
//     const myTeachSkills = (mySkill.teachSkill || []).map(skill =>
//       skill.toLowerCase().trim()
//     );

//     const myLearnSkills = (mySkill.learnSkill || []).map(skill =>
//       skill.toLowerCase().trim()
//     );
...
//       const otherTeachSkills = (otherSkill.teachSkill || []).map(skill =>
//         skill.toLowerCase().trim()
//       );

//       const otherLearnSkills = (otherSkill.learnSkill || []).map(skill =>
//         skill.toLowerCase().trim()
//       );


//       // Mera learn unke teach mein hai?
//       const theyTeachWhatIWantToLearn = myLearnSkills.some(skill =>
//         otherTeachSkills.includes(skill)
//       );


//       // Unka learn mere teach mein hai?
//       const iTeachWhatTheyWantToLearn = otherLearnSkills.some(skill =>
...
//         const theyCanTeachYou = myLearnSkills.filter(skill =>
//           otherTeachSkills.includes(skill)
//         );

//         const youCanTeachThem = otherLearnSkills.filter(skill =>
//           myTeachSkills.includes(skill)
//         );
